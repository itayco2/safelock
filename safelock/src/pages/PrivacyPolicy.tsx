        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          <div className="bg-white rounded-lg shadow-lg p-8 space-y-8">
            ...
            <section>
              ...
              <ul className="list-disc list-inside space-y-2 text-gray-700 mr-4 mt-3">
            ...
            <section>
              ...
              <div className="bg-gray-50 p-6 rounded-lg">
                <p className="text-gray-700 mb-2"><strong>טלפון:</strong> 053-3570350</p>
                <p className="text-gray-700 mb-2"><strong>אימייל:</strong> office.safelock@gmail.com</p>
                <p className="text-gray-700"><strong>כתובת:</strong> בן-גוריון 190 גבעתיים, ישראל</p>
              </div>
            </section>
