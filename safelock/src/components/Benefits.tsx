...
const Benefits = () => {
  ...
  return (
    <>
      <Helmet>
        <title>למה לבחור ב-Take Safe? - פתרונות כספות מקצועיים</title>
        <meta
          name="description"
          content="Take Safe מציעה ניסיון של שנים בתחום הכספות עם שירות מהיר, אמין ומקצועי. פתרון כולל לכל צורכי הכספות שלך."
        />
        <html lang="he" />
      </Helmet>
