    ...
    >
      <div className="max-w-6xl mx-auto text-center">
        ...
        <h1 className="text-4xl md:text-6xl font-extrabold text-slate-900 mb-4 leading-tight">
          ...
          <br />
          <span className="text-blue-900" lang="he">אבטחה מקצועית ושקט נפשי</span>
        </h1>
        ...
        <Button
          ...
          aria-label="גלול לטופס יצירת קשר לקבלת הצעת מחיר"
        >
          אני רוצה הצעת מחיר
        </Button>

        {/* Benefits List */}
        <section aria-labelledby="benefits-heading" className="max-w-3xl mx-auto" lang="he">
          <h2 id="benefits-heading" className="text-2xl md:text-3xl font-bold text-slate-900 mb-8">
            למה לבחור ב-Take Safe?
          </h2>
          <ul className="grid grid-cols-1 md:grid-cols-2 gap-y-4 gap-x-8 text-right list-none">
            {benefits.map((benefit, index) => (
              <li key={index} className="flex items-start gap-2">
                <span className="text-green-600 text-xl" aria-hidden="true">✔️</span>
